...
<head>
            ...
            theme: {
                extend: {
                    ...
                    keyframes: {
                        ...
                        pulseRing: {
                            '0%,100%': {
                                boxShadow: '0 0 0 3px rgba(59,193,168,.3)'
                            },
                            '50%': {
                                boxShadow: '0 0 0 7px rgba(59,193,168,.07)'
                            }
                        },
                        waveMove: {
                            from: {
    ...
    <style>
        ...
        .drop {
            ...
            background: linear-gradient(180deg, rgba(59, 193, 168, .45), rgba(12, 119, 121, .2));
        ...
        .feature-card::before {
            ...
            right: 0;
            height: 3px;
            background: linear-gradient(90deg, #249E94, #3BC1A8);
            transform: scaleX(0);
        ...
        .steps-row::before {
            ...
            right: 14%;
            height: 1px;
            background: linear-gradient(90deg, transparent, rgba(59, 193, 168, .35), transparent);
        }
        ...
        @keyframes pulseRing {
            ...
            0%,
            100% {
                box-shadow: 0 0 0 3px rgba(59, 193, 168, .3);
            }

            50% {
                box-shadow: 0 0 0 7px rgba(59, 193, 168, .07);
            }
        }
...
<body class="bg-mesh text-[#0a2a2f] overflow-x-hidden min-h-screen">
    ...
    <nav class="fixed top-0 inset-x-0 z-50 flex items-center justify-between px-6 lg:px-10 h-[70px]"
        ...
        <ul class="hidden md:flex items-center gap-1 list-none">
            ...
            @else
            <li><a href="{{ route('login') }}" class="ml-2 text-sm font-semibold text-white px-5 py-2 rounded-lg transition-all hover:-translate-y-px"
                    style="background:linear-gradient(135deg,#249E94,#3BC1A8);box-shadow:0 2px 14px rgba(59,193,168,.4);">Log in</a></li>
